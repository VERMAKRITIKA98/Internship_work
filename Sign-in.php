...
<body>
<div class="container">
<div><center><h3><strong>Welcome Back!</strong></h3></center></div>
  ...
  if($rows>0 && $data['status']==1)
  {
   ...
   <script>
    Swal.fire({
      icon:'success',
  title: 'Login success',
  text: 'You will redirect within a moment please wait...',
    showConfirmButton: false,
  timer: 2000
}).then(function() {<?php 
  redirection($data['role']);
?> 
})
   </script>
<?php
 }
else if($rows>0 && $data['status']!=1)
  {
   ?>
   <script>
    Swal.fire({
